...
class Elevator {
    ...
    /** 從等待乘客中挑出一位 */
    selectPassenger(floorPassengers) {
    ...
    /** 乘客進電梯 */
    pickPassengers(floorPassengers) {
        const passengers = floorPassengers.get(this.floor);
...
Elevator.CAPACITY = 5;
/** 開門時間為1秒 */
Elevator.OPEN_TIME = 1;
/** 每層樓移動時間為1秒 */
Elevator.MOVING_TIME = 1;
...
(function (Elevator) {
    ...
    (function (Direction) {
        ...
        Direction["Up"] = "Up";
        Direction["Down"] = "Down";
    })(Direction = Elevator.Direction || (Elevator.Direction = {}));
